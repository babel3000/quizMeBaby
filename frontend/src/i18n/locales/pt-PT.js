export default {
  ...
  host: {
    ...
    moderationHost: 'Controlado pelo anfitrião',
    moderationPlayers: 'Controlado pelas equipas',
  ...
  results: {
    ...
    readyForNext: 'Pronto para próxima pergunta',
    readyMarked: 'Pronto ✓',
    readyCount: '{ready}/{total} equipas prontas',
